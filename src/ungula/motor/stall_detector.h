...
namespace ungula::motor
{
    ...
    public:
        ...
        void configureForSpeed(int32_t speedSps)
        {
            ...
            uint16_t linearBaseline = static_cast<uint16_t>(sgPerSps_ * static_cast<float>(speedSps));
            uint16_t baseline = (linearBaseline < sgBaselineCap_) ? linearBaseline : sgBaselineCap_;
        ...
        {
            uint16_t linear = static_cast<uint16_t>(sgPerSps_ * static_cast<float>(currentSpeedSps_));
