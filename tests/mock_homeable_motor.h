...
namespace ungula::motor
{
    namespace test
    {
        ...
        public:
            ...
            {
                return (dir == Direction::BACKWARD) ? scriptedLimitBackward : scriptedLimitForward;
            }
            ...
            {
                return (dir == Direction::BACKWARD) ? scriptedLimitCountBackward : scriptedLimitCountForward;
            }
